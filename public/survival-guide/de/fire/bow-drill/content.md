...
- **Stab**: Ein gerader, trockener Weichholzstab (Weide, Zeder, Pappel)
- **Feuerbrett**: Ein flaches Stück trockenes Weichholz, ca. 2,5 cm dick
...
3. **Mache die Kerbe**
   - Schneide eine V-förmige Kerbe vom Rand des Feuerbretts zur Vertiefung

4. **Positioniere den Stab**
   - Lege den Stab in die Vertiefung mit der Kerbe zu dir gerichtet

5. **Befestige die Bogenschnur**
   - Wickele die Schnur einmal um den Stab in einer Schleife

6. **Setze den Handgriff auf**
   - Drücke den Handgriff fest auf den Stab

7. **Beginne zu bohren**
   - Verwende lange, gleichmäßige Bewegungen, um den Stab schnell zu drehen
