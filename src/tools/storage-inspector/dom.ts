...
export function getElements(): StorageInspectorElements {
  return {
    ...
    localBody: document.getElementById('local-body') as HTMLTableSectionElement,
    sessionBody: document.getElementById('session-body') as HTMLTableSectionElement,
    cacheBody: document.getElementById('cache-body') as HTMLTableSectionElement,
    idbBody: document.getElementById('idb-body') as HTMLTableSectionElement,
    cookieBody: document.getElementById('cookie-body') as HTMLTableSectionElement,
