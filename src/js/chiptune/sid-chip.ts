...
export class SIDChip {
  ...
  public write(reg: number, val: number): void {
    ...
    if (v < 3) {
      ...
      switch (r) {
        case 0:
          voice.freq = (voice.freq & 0xff00) | val;
          break;
        case 1:
          voice.freq = (voice.freq & 0x00ff) | (val << 8);
          break;
        case 2:
          voice.pw = (voice.pw & 0xff00) | val;
          break;
        case 3:
          voice.pw = (voice.pw & 0x00ff) | ((val & 0x0f) << 8);
          break;
        case 4:
          voice.ctrl = val;
          break;
      ...
      switch (reg) {
        case 21:
          this.fltFc = (this.fltFc & 0x700) | val;
          break;
        case 22:
          this.fltFc = (this.fltFc & 0x0ff) | (val << 8);
          break;
        case 23:
          this.fltRes = val >> 4;
          break; // Res
